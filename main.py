...
def send_email_notification(subject, body):
    try:
        # Email configuration
        sender_email = "wellm1696@gmail.com"  # Replace with your email
        sender_password = "emxwotmqjiijjfmn"  # Replace with your email password
        recipient_email = "officeprojects098@gmail.com"  # Hardcoded recipient email
...
def generate_token(name, person_count, method):
    ...
    email_subject = f"Token Generated for {name}"
    email_body = token_details
...
st.write("""
    ...
    - **Email Notifications**: Get notified via email when a token is generated! 📧
